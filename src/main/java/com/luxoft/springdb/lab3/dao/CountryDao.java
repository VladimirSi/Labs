...
public class CountryDao extends JdbcDaoSupport {
	...
	private static final String DELETE_COUNTRY_NAME_SQL_1 = "delete from country  where code_name='";
	...
	public void createCountry(String codeName, String newCountryName) {
			String sql = LOAD_COUNTRIES_SQL + "('" + newCountryName + "', '"
					+ codeName + "');";
			getJdbcTemplate().execute(sql);
	}

	public void deleteCountry(String codeName) {
		getJdbcTemplate().execute(
				DELETE_COUNTRY_NAME_SQL_1 + codeName + "'");
	}
